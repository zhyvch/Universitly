...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='homeworks', to='courses.sectionhomework', verbose_name='Related test'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            name='test',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='attempts', to='courses.sectiontest', verbose_name='Attempted test'),
        ),
        migrations.AddField(
            model_name='studenttestattempt',
            name='student',
